...
public class MessageController {
    ...
    public JSONObject messageOperate(@RequestParam("message_id")String messageId,
        ...
        try{
            ...
            return MyUtil.response(0,"消息处理成功");
        }catch (Exception e){
            logger.error("消息处理出错" + e.getMessage());
            return MyUtil.response(1, "消息处理出错!");
        }
